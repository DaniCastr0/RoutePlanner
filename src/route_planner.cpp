...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    //https://stackoverrun.com/es/q/1006110 
    std::sort(open_list.begin(),open_list.end(),[](const auto &val, const auto &nextval){return val->h_value + val->g_value < nextval->h_value + nextval->g_value;});
    auto *firstvalue=open_list.front();
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    while (current_node->parent!=0)
    {
        ...
        //std::cout<<current_node->g_value<<std::endl;
